...
const publishProduct = async (product_id) => {
  try {
    ...
    const response = await axios.post(
      `https://api.printify.com/v1/shops/12652066/products/65e38a2900da220a850f430a/publishing_succeeded.json`, // Corrected endpoint
      {
        "external": {
            "id": "65c54e726a56e47eba094950",
            "handle": "/products/iPhone%20Cases/65e38a2900da220a850f430a"
        }
    },
      {
        headers: {
