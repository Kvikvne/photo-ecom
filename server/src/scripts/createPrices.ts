...
/**
 * This script pulls all existing products from Printify,
 * checks if Stripe prices already exist in the DB, and creates missing ones.
 */
...
syncExistingPrintifyProductsToStripe();
