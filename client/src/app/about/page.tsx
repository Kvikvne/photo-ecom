                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                            Capturing the raw beauty of nature and transforming
                            it into timeless art pieces that bring the beauty of
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-4 text-muted-foreground leading-relaxed">
                                <p>
                                    Hey, I'm Kai. I'm a software engineer by day
                                    and a photographer at heart. This site is a
                                    personal project where I get to blend those
                                    two worlds code and creativity. Most of the
                                    photos in this collection were taken over
                                    the years while growing up on Kauai, a place
                                    that shaped how I see the world and what I
                                    choose to capture. That connection makes
                                    every image deeply personal to me. I focus
                                    on waves, landscapes, and natural moments
                                    that tell a story or hold a feeling. Every
                                    print here was photographed, selected, and
                                    prepared by me.
                                </p>
                                <p>
                                    This project isn't just about photography,
                                    it's about intention. Writing code all day
                                    can be technical and fast paced, but this
                                    work allows me to slow down, create with my
                                    hands and eyes, and connect with others.
                                    Each piece is printed using premium
                                    materials to ensure the colors stay vibrant,
                                    the details stay sharp, and the moment
                                    endures. Thanks for being here. It truly
                                    means a lot.
                                </p>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {valueCards.map((value, idx) => {
                            const Icon =
                                iconMap[value.iconName as keyof typeof iconMap];
            ...
            <section className="py-16 px-4 sm:px-6 lg:px-8 bg-primary text-background">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl text-background mb-8 leading-relaxed">
                        Discover my collection of canvas prints and bring the
                        beauty of Kauai into your home.
                    </p>
                    <Button
