    ...
    <section className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-0">
      ...
      <div className="space-y-8 text-muted-foreground">
        <div>
          ...
          <p>
            Because each item is made to order, we don’t offer returns or
            exchanges. We do accept cancellations if your item hasn’t entered
            production yet. If something arrives damaged, we’ll make it
            right—just get in touch. Thanks for understanding.
          </p>
        </div>
        {returnsPolicyItems.map((section, idx) => (
          <div key={idx} className="space-y-4">
            <h2 className="font-bold text-2xl text-primary">{section.title}</h2>
